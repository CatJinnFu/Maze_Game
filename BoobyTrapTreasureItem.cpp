 ...
 *******************************************************************
 * File: BoobyTrappedTreasureItem.cpp
 * Author:	 D. Schmid			Date Created:	7/10/2011
 * Last Modified by:				Date Modified:	
 * 
 * Comments:
 *
 * trap and treasure - nver got to finsih the multiple inhertiance :(
 *******************************************************************
*/
...
BoobyTrappedTreasureItem::BoobyTrappedTreasureItem(){};

BoobyTrappedTreasureItem::BoobyTrappedTreasureItem(int x, int y): BoobyTrapItem(x,y), TreasureItem(x,y){
		posX = x;
		posY = y;
...
int BoobyTrappedTreasureItem::getScoreValue(){return -1;}

int BoobyTrappedTreasureItem::addCoins(){return 1;}

string BoobyTrappedTreasureItem::getDetails(){return "Oh wtf a trap and coins!";} 