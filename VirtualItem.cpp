...
void VirtualItem::setPos(int x, int y)
{
		posX = x;
		posY = y;
...
void VirtualItem::getPos(int & x, int & y)
{
		x = posX;
		y = posY;
}

int VirtualItem::getPosX(){return posX;}

int VirtualItem::getPosY(){return posY;}

char VirtualItem::getMaker(){return marker;}; 

string VirtualItem::getDetails(){return details;}; 