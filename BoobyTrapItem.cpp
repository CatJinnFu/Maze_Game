...
*
 *******************************************************************
 * File: BoobyTrapItem.h
 * Author:	D. Schmid				Date Created:	2/09/2011
 * Last Modified by:				Date Modified:	
 * 
 * Comments:
 *
 * An item thats really a trap
 *******************************************************************
*/

#include "BoobyTrapItem.h"

BoobyTrapItem::BoobyTrapItem(){};

BoobyTrapItem::BoobyTrapItem(int x, int y){
...
int BoobyTrapItem::getScoreValue(){return -1;}

int BoobyTrapItem::addCoins(){return 0;};

string BoobyTrapItem::getDetails(){return "A trap!";} 